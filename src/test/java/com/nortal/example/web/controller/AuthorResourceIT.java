...
import com.nortal.example.repository.AuthorRepository;
...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().fistName(DEFAULT_FIST_NAME).lastName(DEFAULT_LAST_NAME);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().fistName(UPDATED_FIST_NAME).lastName(UPDATED_LAST_NAME);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getFistName()).isEqualTo(DEFAULT_FIST_NAME);
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.fistName(UPDATED_FIST_NAME).lastName(UPDATED_LAST_NAME);
        ...
        Author testAuthor = authorList.get(authorList.size() - 1);
        assertThat(testAuthor.getFistName()).isEqualTo(UPDATED_FIST_NAME);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.fistName(UPDATED_FIST_NAME).lastName(UPDATED_LAST_NAME);
