package com.nortal.example.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nortal.example.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nortal.example.repository.UserRepository.USERS_BY_EMAIL_CACHE);
